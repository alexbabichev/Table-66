...
public class JsonUtil {
    ...
    public static void writePrettyJson(Path to, Object obj) throws IOException {
        OBJECT_MAPPER.writerWithDefaultPrettyPrinter().writeValue(to.toFile(), obj);
    }
